...
void loop() {
  ...
  //itoa(packetnum++, radiopacket+13, 10);
  Highbit_port = digitalRead(10);
  Midbit_port = digitalRead(9);
  Lowbit_port = digitalRead(8);
  Highbit_star = digitalRead(7);
  Midbit_star = digitalRead(6);
  Lowbit_star = digitalRead(5);
  calibrate = digitalRead(A0);
  // UP - 000
  // Down - 001
  // Left - 010
  // Right - 011
